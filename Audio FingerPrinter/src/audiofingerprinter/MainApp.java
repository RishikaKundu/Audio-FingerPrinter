...
/**
 * Creates the user interface and runs the audio fingerprinting application. Created by bjackson on
 * 11/15/2015.
 */
public class MainApp extends Application {
    ...
    public Parent createContent(Stage primaryStage) {
        // Border pane allows us to layout content along the top, bottom, left, right, and center of the
        // window.
    ...
    /**
     * Javafx method to initialize the application. See
     * http://docs.oracle.com/javase/8/javase-clienttechnologies.htm for more details on how to create
     * graphical user interfaces using java.
     * 
     * @param primaryStage
     */
    @Override
    public void start(Stage primaryStage) {
        ...
        recognizer = new AudioFingerprinterSample(songDB);

        if (recognizer == null) {
            throw new RuntimeException(
                "The recognizer variable in the MainApp class is null. You need to initialize it in the start method.");
        }
